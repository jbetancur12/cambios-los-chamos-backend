...
export class Migration20260218014430 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "product_transactions" ("id" varchar(255) not null, "product_id" varchar(255) not null, "type" text check ("type" in ('PURCHASE', 'SALE', 'ADJUSTMENT')) not null, "quantity" int not null, "price_per_unit" numeric(14,2) not null, "total_price" numeric(14,2) not null, "profit" numeric(14,2) null, "created_by_id" varchar(255) not null, "created_at" timestamptz not null, constraint "product_transactions_pkey" primary key ("id"));`);
