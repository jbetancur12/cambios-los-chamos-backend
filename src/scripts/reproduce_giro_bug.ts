...
async function run() {
    try {
        ...
        console.log(`Initial State: CreditLimit=${minorista.creditLimit}, Available=${minorista.availableCredit}, Debt=${minorista.creditLimit - minorista.availableCredit}`);
        ...
        console.log(`Final State: CreditLimit=${minorista.creditLimit}, Available=${minorista.availableCredit}, Debt=${minorista.creditLimit - minorista.availableCredit}`);
        ...
        // Check transactions
        const transactions = await em.find(MinoristaTransaction, { minorista: minorista.id }, { orderBy: { createdAt: 'DESC' }, limit: 5 });
        ...
        console.log(`Final State after 2nd Giro: CreditLimit=${minorista2.creditLimit}, Available=${minorista2.availableCredit}, Debt=${minorista2.creditLimit - minorista2.availableCredit}`);
