...
export const changePasswordSchema = z.object({
  oldPassword: z.string().trim().min(1, 'La contraseña actual es requerida'),
  newPassword: z.string().trim().min(6, 'La nueva contraseña debe tener al menos 6 caracteres'),
})
...
export const resetPasswordSchema = z
  .object({
    ...
    newPassword: z.string().trim().min(6, 'La nueva contraseña debe tener al menos 6 caracteres'),
    confirmNewPassword: z.string().trim().min(6, 'La confirmación de contraseña es requerida'),
  })
